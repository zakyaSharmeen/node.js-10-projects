...
// const stripePromise= loadStripe('pk_test_51QtOuNKKCJbRr8A6870AfRa8JF4UZHu7gYrCOol9DdeSgoEuEHncLM2cI8WhyZtBcQlfdAuiJaQSNCRdD5HTnCUJ00oXkpIbtM')
...
//             }catch(err){
//                 console.error("there is an error processing in the checkout: ", err);
...
//         const totalPrice= cartItems.reduce((acc, item) => acc + item.quantity, 0)
