...
function FoodSingleCard({ food }) {
  const {addToCart,
      removeFromCart,
      decreaseCartItemQuantity,
      clearCart, cartItems} = useCart()
    ...
    <div className="border rounded-lg overflow-hidden shadow-lg hover:shadow-2xl m-4 bg-gradient-to-br from-green-50 to-green-100 relative">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-end items-center gap-x-2 absolute bottom-0 right-0">
          <>
            <button onClick={handleToRemoveCart} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-tl-lg">
          ...
          <button onClick={handleToCart}
            className={`bg-gradient-to-r from-green-500 to-green-700 hover:from-green-700 hover:to-green-900 text-white font-bold
